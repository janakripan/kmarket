...
const About = ({ id }) => {
  ...
  return (
    <div
      id={id}
      ref={sectionRef}
      className="w-full h-fit min-h-screen flex flex-col gap-16 px-6 lg:px-16 "
    >
      {/* ===== logo section =====  */}

      <div className="w-full h-fit flex flex-col gap-6 lg:gap-3.75 ">
        {/* header  */}
        ...
        <div className="w-full h-fit grid grid-cols-2 md:grid-cols-3 lg:flex lg:flex-row lg:justify-between gap-4 lg:gap-0 branches-container overflow-hidden">
          {branchesLogo.map((itm, idx) => (
            <div
              ...
              className="flex items-center justify-center bg-black rounded-xl w-full lg:w-[156px] aspect-square lg:h-[156px] "
            >
              <img
                src={itm}
                alt="partner logo"
                className={` aspect-square ${idx !== 0 ? "w-20 lg:w-28" : " w-10 lg:w-14"} `}
              />
            </div>
          ))}
        </div>
      ...
      {/* about kmart  */}
      <div className="w-full h-fit flex flex-col lg:flex-row items-start gap-12 lg:gap-0">
        {/* left contetn  */}
        <div className="w-full lg:w-1/2 h-full flex flex-col justify-between items-start gap-12 lg:gap-24 about-text-content order-2 lg:order-1">
          <div className="w-full h-fit flex flex-col items-start gap-4 lg:gap-2.25 ">
            <h5 className="font-dmSans w-fit px-2 pb-1 font-bold text-[#5D666F] text-sm border-b border-[#5E8409] ">
              About K MART GROUP
            </h5>

            <div className="w-full h-fit flex flex-col gap-5.5 items-start">
              <div className="w-full h-fit flex flex-col gap-4 lg:gap-2.25 items-start">
                {/* header  */}
                <h2 className="font-bold font-redHat text-3xl lg:text-[48px] text-[#1C2539] leading-tight lg:leading-12 ">
                  Smart and effective <br className="hidden lg:block" />{" "}
                  business Group in <span className="text-primary">UAE</span>.
                </h2>

                {/* description  */}
                <p className="w-full h-fit text-left leading-relaxed text-[#5D666F] font-normal text-sm font-dmSans ">
              ...
              <div className="w-fit h-fit flex flex-col sm:flex-row items-start sm:items-center gap-8 lg:gap-14 ">
                {/* contact no  */}
          ...
          <button className="px-8 py-3.5 rounded-[16px] bg-primary text-sm font-semibold text-[#F1F1F1] font-dmSans ">
            About Us
          </button>
        </div>
        ...
        <div
          ref={aboutImageRef}
          className="w-full lg:w-1/2 aspect-video lg:aspect-square max-h-118 flex items-center justify-center relative rounded-3xl overflow-hidden order-1 lg:order-2"
        >
          {/* white layout  */}
          ...
          <div className="absolute bottom-0 left-0 z-10 px-4.5 py-6 flex flex-col items-center w-fit h-fit ">
            <div className="w-16 h-16 lg:w-20 lg:h-20  relative rounded-full border-3 border-white overflow-hidden">
              <div className="w-24 h-24 rounded-full bg-linear-to-r from-[#787878] to-[#121212]  absolute left-[25%] top-1/2 -translate-y-1/2 "></div>

              <div className=" absolute -left-1 top-1/2 -translate-y-1/2 -rotate-90 font-dmSans text-sm lg:text-base text-[#121212]  ">
                80%
              </div>
            </div>
            ...
            <div className="font-dmSans font-bold text-sm lg:text-lg text-[#121212]  ">
              Business Progress
            </div>
          </div>
        </div>
      ...
      <div className="w-full h-fit flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
        {/* left image  */}

        <div
          ref={whatWeDoImageRef}
          className="w-full lg:w-1/2 aspect-video lg:aspect-square max-h-[632px] flex items-center justify-center relative rounded-3xl overflow-hidden "
        >
          {/* about-image  */}
          <img
            src={whatWeDo}
        ...
        <div className="w-full lg:w-1/2 h-full flex flex-col items-start gap-8 lg:gap-24 what-we-do-text">
          <div className="w-full h-fit flex flex-col items-start gap-4 lg:gap-2.25 ">
            <h5 className="font-dmSans w-fit px-2 pb-1 font-bold text-[#5D666F] text-sm border-b border-[#5E8409] ">
              What We Do
            </h5>
            ...
            <div className="w-full h-fit flex flex-col gap-5.5 items-start">
              <div className="w-full h-fit flex flex-col gap-6 lg:gap-5.5 items-start">
                {/* header  */}
                <h2 className="font-bold font-redHat text-3xl lg:text-[48px] text-[#1C2539] leading-tight lg:leading-12 ">
